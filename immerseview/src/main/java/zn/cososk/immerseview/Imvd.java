...
public class Imvd extends ViewGroup implements View.OnClickListener {
    ...
    public Imvd(Context context) {
        super(context);
        init(context);
    }

    public Imvd(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public Imvd(Context context, AttributeSet attrs, int defStyleAttr) {
